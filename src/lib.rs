...
//! over a dlpk CUDA [`rgmin::vecops::Vector`], host fallback when
//! this build has no kernel backend.
//!
...
pub use gpu::{
    GPU_MIN_DIM, GpuPolicy, gpu_eigh, gpu_eigh_t, gpu_ok, gpu_project, gpu_qr, to_gpu,
    to_gpu_matrix,
};

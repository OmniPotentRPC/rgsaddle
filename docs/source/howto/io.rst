...
or dimer trace. vesin is not a Cargo feature here: a surface that needs a
cutoff pair list depends on vesin itself. rgsaddle does not
grow a second neighbour list.
